  ...
  return (
    ...
    >
      <SurfaceCard className="space-y-3">
        <h2 className="text-xl font-semibold text-slate-50">1. Search or move the map</h2>
      ...
      <SurfaceCard className="space-y-3">
        <h2 className="text-xl font-semibold text-slate-50">2. Read the visible heat zones</h2>
        <p className="text-base leading-7 text-slate-300">
      ...
      <SurfaceCard className="space-y-3">
        <h2 className="text-xl font-semibold text-slate-50">3. Inspect the underlying reports</h2>
        <p className="text-base leading-7 text-slate-300">
