  ...
  return (
    ...
    >
      <SurfaceCard className="space-y-3">
        <h2 className="text-xl font-semibold text-slate-50">Source types</h2>
      ...
      <SurfaceCard className="space-y-3">
        <h2 className="text-xl font-semibold text-slate-50">Countries covered</h2>
      ...
      <SurfaceCard className="space-y-3">
        <h2 className="text-xl font-semibold text-slate-50">Normalization</h2>
        <p className="text-base leading-7 text-slate-300">
      ...
      <SurfaceCard className="space-y-3">
        <h2 className="text-xl font-semibold text-slate-50">Retention</h2>
        <p className="text-base leading-7 text-slate-300">
