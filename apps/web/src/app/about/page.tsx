  ...
  return (
    ...
    >
      <SurfaceCard className="space-y-3">
        <h2 className="text-xl font-semibold text-slate-50">Product focus</h2>
      ...
      <SurfaceCard className="space-y-3">
        <h2 className="text-xl font-semibold text-slate-50">Current scope</h2>
        <p className="text-base leading-7 text-slate-300">
      ...
      <SurfaceCard className="space-y-3" id="developer">
        <h2 className="text-xl font-semibold text-slate-50">Developer</h2>
        <p className="text-base leading-7 text-slate-300">
