  ...
  return (
    ...
    >
      <SurfaceCard className="space-y-3">
        <h2 className="text-xl font-semibold text-slate-50">No account required</h2>
      ...
      <SurfaceCard className="space-y-3">
        <h2 className="text-xl font-semibold text-slate-50">Local device state</h2>
        <p className="text-base leading-7 text-slate-300">
      ...
      <SurfaceCard className="space-y-3">
        <h2 className="text-xl font-semibold text-slate-50">Infrastructure logs</h2>
        <p className="text-base leading-7 text-slate-300">
